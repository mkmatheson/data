export const entries: { timestamp: Date; entry: string }[] = [
  {
    timestamp: new Date('Sat Jan 03 2026 21:58 GMT-0800'),
    entry: `
    Probably could have gone to bed much earlier but I fixed some bugs with how the inverted colors / opacity were getting calculated. Also updated the heatmap colors
    `
  },
  {
    timestamp: new Date('Sat Jan 03 2026 20:22 GMT-0800'),
    entry: `
    Spent way too much time figuring out a standard heatmap. Added a "how i was feeling" section as well.
    `
  },
  {
    timestamp: new Date('Sat Jan 03 2026 17:48 GMT-0800'),
    entry: `
